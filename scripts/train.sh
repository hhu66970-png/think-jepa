...
DENSE_JEPA_KEEP_SOURCE="${DENSE_JEPA_KEEP_SOURCE:-redundancy}"
DENSE_JEPA_RECEIVER_SEARCH="${DENSE_JEPA_RECEIVER_SEARCH:-cell}"
DENSE_JEPA_KEEP_SCORE_ALPHA="${DENSE_JEPA_KEEP_SCORE_ALPHA:-1.0}"
DENSE_JEPA_KEEP_SCORE_BETA="${DENSE_JEPA_KEEP_SCORE_BETA:-0.0}"
DENSE_JEPA_SIMILARITY_GATE_EPSILON="${DENSE_JEPA_SIMILARITY_GATE_EPSILON:-0.01}"
DENSE_JEPA_DIRECTION_BY_IMPORTANCE="${DENSE_JEPA_DIRECTION_BY_IMPORTANCE:-1}"
...
CMD=(
  ...
  --dense_jepa_keep_source "${DENSE_JEPA_KEEP_SOURCE}"
  --dense_jepa_receiver_search "${DENSE_JEPA_RECEIVER_SEARCH}"
  --dense_jepa_keep_score_alpha "${DENSE_JEPA_KEEP_SCORE_ALPHA}"
  --dense_jepa_keep_score_beta "${DENSE_JEPA_KEEP_SCORE_BETA}"
  --dense_jepa_similarity_gate_epsilon "${DENSE_JEPA_SIMILARITY_GATE_EPSILON}"
)
...
if [[ "${DENSE_JEPA_DIRECTION_BY_IMPORTANCE}" != "1" ]]; then
  CMD+=(--no_dense_jepa_direction_by_importance)
fi
